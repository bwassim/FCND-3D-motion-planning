...
from grid_planning_utils import a_star, heuristic, create_grid, read_csv, prune_path
...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, global_goal_position=None):
        ...
        print("global_goal_position",global_goal_position)
    ...
    def plan_path(self):
        ...
        local_north, local_east, local_d = global_to_local(self.global_position, self.global_home)
        print('local north {0}, local east {1}, local down {2}'.format(local_north, local_east, local_d))
        ...
        print('start_north, start_east', grid_start)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_lat', type=float, default=37.795845, help="Goal latitude")
    parser.add_argument('--goal_lon', type=float, default=-122.401500, help="Goal longitude")
